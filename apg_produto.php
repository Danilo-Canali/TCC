...
<html lang="pt-br">
	...
	<body>
    	...
    	<a href="cadastro_produtos.php"> <input type="button"  value= "Cadastrar"></a> &nbsp 
         <a href= "editar_produto.php"> <input type="button"  value="Alterar"></a> &nbsp
		...
		//Setar a quantid_produade de itens por pagina
		$qnt_result_pg = 3;
		...
		while($row_produto = mysqli_fetch_assoc($resultado_produtos)){
			...
			echo "Descrição: " . $row_produto['descricao'] . "<br> <br>";
		

 		
			echo "<a href='apaga_produto.php?id_produ=" . $row_produto['id_produ'] . "'>Apagar</a><br><hr>";
		}
		...
		$quantid_produade_pg = ceil($row_pg['num_result'] / $qnt_result_pg);
		
		//Limitar os link antes depois
		$max_links = 2;
		echo "<a href='apg_produto.php?pagina=1'>Primeira</a> ";
		
		for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
			if($pag_ant >= 1){
				echo "<a href='apg_produto.php?pagina=$pag_ant'>$pag_ant</a> ";
			}
		}
		...
		for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
			if($pag_dep <= $quantid_produade_pg){
				echo "<a href='apg_produto.php?pagina=$pag_dep'>$pag_dep</a> ";
			}
		}
		
		echo "<a href='apg_produto.php?pagina=$quantid_produade_pg'>Ultima</a>";
