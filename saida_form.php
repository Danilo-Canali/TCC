...
<?php
  ...
  //ob_start();
    ...
    if((isset($_POST['email'])) && (isset($_POST['senha'])))
    {
        ...
        $result_usuario = "SELECT codigo, nome, email, senha, celular, cpf, rua, nascimento, cidade, bairro, numero, cep, estado FROM cliente WHERE email = '$usuario' && senha = '$senha' LIMIT 1";
        ...
        {   
            ...
            header("Location: login_cliente.php?id_produ=$id_produ");  
        }
    }
    else
    {
...
$query_products = "SELECT id_produ, nm_produ, estoque, preco, descricao, img FROM produto WHERE id_produ =:id_produ LIMIT 1";
 
$result_products = $conn2->prepare($query_products);
$result_products->bindParam(':id_produ', $id_produ, PDO::PARAM_INT);
...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="wid_produth=device-wid_produth, initial-scale=1, shrink-to-fit=no">
        <img src='<?php echo "vitrine/img/$img"; ?>'  alt="" wid_produth="250" height="250" >
...
<form method="POST" action="pdf_teste.php?id_produ=<?php echo $id_produ; ?>">
                    ...
                    ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="cpf" id="cpf" class="form-control" placeholder="Somente números" maxlength="14" oninput="maskcpf(this)" value="<?php
